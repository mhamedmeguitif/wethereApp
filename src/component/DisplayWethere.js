...
export default function UserLocation(props) {
    ...
    const { temperature, description, location, region, country, wind_speed, pressure, precip, humidity, imge } = props.weather;
        ...
        <div className="user-weather">
            <div className="row">
                ...
                <div className="col-md-9">
                    <img className="mainImg" src={imge} alt="weather-img" />
                </div>
            </div>
